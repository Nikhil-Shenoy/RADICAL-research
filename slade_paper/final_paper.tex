...
\section{Introduction}
	...
	\subsection{Ensemble-MD Toolkit} 
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=9cm,height=7cm]{pipeline_pattern}
	...
	\subsection{RADICAL-Pilot and RADICAL-Pilot-YARN}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=9cm,height=7cm]{rp_arch}
