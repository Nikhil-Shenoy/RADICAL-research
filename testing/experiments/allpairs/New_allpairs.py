...
if __name__ == "__main__":
	...
	elapsed_time = float(script_diff.total_seconds())

	scriptStr = "scriptTimes-{0}-{1}.txt".format(setCount,coreCount)
	scriptTime = open(scriptStr,"a")
	scriptTime.write(str(elapsed_time))
	scriptTime.write("\n")
	scriptTime.close()
