...
if __name__ == "__main__":
	...
	print "And now we print the execution_profile_dict\n\n"

	profileDict = randomsa.execution_profile_dict

	dictFile.write(str(profileDict))
	dictFile.close()

	print "Now we print the execution_profile_dataframe"
	dataframeDict = randomsa.execution_profile_dataframe
	frameFile = open("frame.txt","w")
	frameFile.write(str(dataframeDict))
	frameFile.close()
